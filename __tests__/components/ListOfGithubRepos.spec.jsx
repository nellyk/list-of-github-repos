...
import {
  ListOfGithubRepos, mapDispatchToProps, mapStateToProps, load,
} from '../../src/components/ListOfGithubRepos';
...
describe('ListOfGithubRepos should render as expected', () => {
  it('module should render correct JSX', () => {
    ...
    const renderedModule = shallow(<ListOfGithubRepos {...props} />);
  ...
  describe('mapDispatchToProps', () => {
    it('should update the browser locale and then reload the language pack', async () => {
      ...
      expect(mockDispatch).toHaveBeenNthCalledWith(2, 'I am loading the language pack for list-of-github-repos and my fallback locale is en-US');
    });
  });

  describe('holocronModule load', () => {
    it('should load language pack for list-of-github-repos module', () => {
      const mockDispatch = jest.fn();
      load()(mockDispatch);
      expect(mockDispatch.mock.calls[0][0]).toBe('I am loading the language pack for list-of-github-repos and my fallback locale is en-US');
    });
  });
});
